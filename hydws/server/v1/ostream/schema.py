...
class BoreholeSchema(SchemaBase):
    ...
    bedrockaltitude_value = fields.Float()
    bedrockaltitude_uncertainty = FloatPositive()
    bedrockaltitude_loweruncertainty = FloatPositive()
    bedrockaltitude_upperuncertainty = FloatPositive()
    bedrockaltitude_confidencelevel = ConfidenceLevel()
