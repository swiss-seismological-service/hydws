...
FILTER_SECTIONS = [
    ...
    ('topaltitude_value', 'ge', 'mintopaltitude'),
    ('topaltitude_value', 'le', 'maxtopaltitude'),
    ('bottomaltitude_value', 'ge', 'minbottomaltitude'),
    ('bottomaltitude_value', 'le', 'maxbottomaltitude'),
