...
def get_hydraulics(filename_list, section_index):
    hydraulic_samples = []
...
def borehole_sections(transformer):
    ...
    for filename_list, section_index in filenames:
        ...
        hydraulic_samples = get_hydraulics(filename_list, section_index)
...
def create_borehole():
    ...
    borehole = Borehole(altitude_value=-LAB_ORIGIN_DEPTH-CB1_TOP_LOCAL_DEPTH,
