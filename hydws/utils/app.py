...
from hydws import utils
from hydws.utils.error import ErrorWithTraceback, ExitCodes
...
class App(object):
    ...
    def __init__(self, log_id='HYDWS'):
        self.parser = None
        self.args = None
        self.log_id = log_id
        self.logger = None
    ...
    def configure(self, path_default_config, config_section=None,
        ...
        # default=PATH_HYDWS_CONF within the child parser
        try:
    ...
    def _build_configfile_parser(self, path_default_config):
        ...
        if path_default_config:
            c_parser.add_argument(
                ...
                metavar="PATH",
                type=utils.realpath,
                help="path to HYDWS Webservice configuration file " +
                     "(default: '%(default)s')")
